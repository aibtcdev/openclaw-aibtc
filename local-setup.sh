...
# Create aibtc-lifecycle skill
cat > data/workspace/skills/aibtc-lifecycle/SKILL.md << 'LIFECYCLEEOF'
---
...
cat > data/workspace/memory/state.json << 'STATEJSONEOF'
{
  "timestamps": {
    "walletCreated": null,
...
cat > data/workspace/memory/identity.md << 'IDENTITYEOF'
# Identity
...
cat > data/workspace/memory/journal.md << 'JOURNALEOF'
# Journal
...
cat > data/workspace/memory/portfolio.json << 'PORTFOLIOEOF'
{
  "lastUpdated": null,
  "network": "unknown",
  "balances": {
...
cat > data/workspace/memory/preferences.json << 'PREFERENCESEOF'
{
  "human": {
...
cat > data/workspace/memory/relationships.json << 'RELATIONSHIPSEOF'
{
  "agents": {},
  "following": [],
  "followers": [],
...
cat > data/workspace/memory/README.md << 'MEMORYREADMEEOF'
# Memory System
